...
ALTER TABLE "user_language" ADD CONSTRAINT "user_language_fk2" FOREIGN KEY ("user_id") REFERENCES "user_account"("id");


ALTER TABLE "skill" ADD CONSTRAINT "skill_fk0" FOREIGN KEY ("group_id") REFERENCES "group_skill"("id");



ALTER TABLE "education" ADD CONSTRAINT "education_fk0" FOREIGN KEY ("city_id") REFERENCES "city"("id");

ALTER TABLE "vacancy" ADD CONSTRAINT "vacancy_fk0" FOREIGN KEY ("creator_id") REFERENCES "user_account"("id");
ALTER TABLE "vacancy" ADD CONSTRAINT "vacancy_fk1" FOREIGN KEY ("company_id") REFERENCES "company"("id");
ALTER TABLE "vacancy" ADD CONSTRAINT "vacancy_fk2" FOREIGN KEY ("city_id") REFERENCES "city"("id");

ALTER TABLE "work_experience" ADD CONSTRAINT "work_experience_fk0" FOREIGN KEY ("city_id") REFERENCES "city"("id");
...
ALTER TABLE "course_2_user" ADD CONSTRAINT "course_2_user_fk1" FOREIGN KEY ("user_id") REFERENCES "user_account"("id");

ALTER TABLE "education_2_user" ADD CONSTRAINT "education_2_user_fk0" FOREIGN KEY ("education_id") REFERENCES "education"("id");
ALTER TABLE "education_2_user" ADD CONSTRAINT "education_2_user_fk1" FOREIGN KEY ("user_id") REFERENCES "user_account"("id");
...
ALTER TABLE "experience_2_user" ADD CONSTRAINT "experience_2_user_fk1" FOREIGN KEY ("user_id") REFERENCES "user_account"("id");

ALTER TABLE "skill_2_user" ADD CONSTRAINT "skill_2_user_fk0" FOREIGN KEY ("skill_id") REFERENCES "skill"("id");
ALTER TABLE "skill_2_user" ADD CONSTRAINT "skill_2_user_fk1" FOREIGN KEY ("user_id") REFERENCES "user_account"("id");
